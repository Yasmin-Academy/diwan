...
export default function PoetryApp() {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 text-center">All Poems</h1>
        ...
        {filteredPoems.map((poem, idx) => (
          <Card key={idx}>
            <CardContent className="p-4">
              <Link to={\`/poem/\${poem.slug}\`} className="text-xl font-semibold mb-2 block text-blue-700 hover:underline">
                {poem.title}
              </Link>
